...
function cargarTransferencia(objTransferencia){
    ...
    axios({
      method: 'post',
      url: 'https://my-json-server.typicode.com/florenciabett/ProyectoJs/transferencias',
...
function obtenerIndice(){
  let transferencias = [];
  axios.get('https://my-json-server.typicode.com/florenciabett/ProyectoJs/transferencias', {
            })
